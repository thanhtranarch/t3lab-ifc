...
// ── Expose on window for HTML handlers (oninput="searchDebounce()",
// onkeydown → searchRun) + tab init (searchInit) ──
Object.assign(window as any, { searchInit, searchRun, searchDebounce });
